...
MODEL               = cobaTugas
MODULES             = rt_logging.c cobaTugas.c cobaTugas_capi.c cobaTugas_data.c cobaTugas_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE            = cobaTugas.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = D:/Tugas/Sistem Kontrol
...
MODELLIB                  = cobaTugaslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = cobaTugas_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/cobaTugas \
